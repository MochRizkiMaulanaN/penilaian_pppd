                    ...
                    <form method="post">
                        ...
                        <table id="form_penilaian" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <input class="form-control" type="number" name="kehadiran" value="<?= $penilaian_ka['kehadiran'] ?>">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="number" name="lari" value="<?= $penilaian_ka['lari'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Pull Up</td>
                                <td>
                                    <input class="form-control" type="number" name="pull_up" value="<?= $penilaian_ka['pull_up'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Sit up</td>
                                <td>
                                    <input class="form-control" type="number" name="sit_up" value="<?= $penilaian_ka['sit_up'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Push Up</td>
                                <td>
                                    <input class="form-control" type="number" name="push_up" value="<?= $penilaian_ka['push_up'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Shuttle Run</td>
                                <td>
                                    <input class="form-control" type="number" name="shuttle_run" value="<?= $penilaian_ka['shuttle_run'] ?>">
                                </td>
                            </tr>
                        </table>
